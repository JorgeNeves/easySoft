...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="True" OnRowDeleting="GridView1_SelectedIndexChanged">
                </asp:GridView>
            </td>
        </tr>
        <tr>
            ...
            <td class="auto-style4">&nbsp;</td>
            <td>Adicionar TAG:<asp:TextBox ID="lblnewtag" runat="server" Height="16px" Width="84px"></asp:TextBox>
                <asp:Button ID="btnok" runat="server" Height="26px" OnClick="btnok_Click" Text="OK" Width="34px" />
            </td>
        </tr>
        <tr>
